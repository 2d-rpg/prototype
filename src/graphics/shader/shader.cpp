...
template <typename T>
void
Shader::set(const std::string &name, T value) const
{
...
bool
Shader::compile_shader(const char * vsource, const char * fsource, unsigned int &ret_shader_program)
{
...
bool
Shader::load_shaders(const char * vfile, const char * ffile, unsigned int &shader_program)
{
